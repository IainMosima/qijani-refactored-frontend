...
import { getProduct, imageStreamer } from "../../../network/products";
            ...
            {productInfo &&
              <div className="table-body">
                <div className="product-name">
                  <img src={imageStreamer(productInfo.productImgKey)} alt={productInfo.productName}/>
              ...
              <div className="delete" onClick={() => deleteItem(productId)}>
                <img src={Images.trashIcon} alt="delete-icon"/>
              </div>
