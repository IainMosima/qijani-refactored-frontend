  ...
  return (
    <div className="app__searchBar w-auto mx-auto">
      <input
        ...
        className="lg:w-[37rem] md:w-[22rem] w-[11rem] sm:h-[3rem] h-[2.5rem] sm:text-lg text-[13px] sm:pl-[1rem] pl-[.7rem] relative"
        placeholder="Search product or category"
        onKeyDown={handleKeyPress}
      />
      {query.length > 0 &&
        <div
          className="absolute p-2 bg-green rounded-full sm:h-[1.7rem] sm:w-[1.7rem] h-[1.5rem] w-[1.5rem] lg:left-[34rem] md:left-[19.5rem] left-[9rem] sm:top-[9px] top-[8px] cursor-pointer flex justify-center place-items-center"
          onClick={() => clear()}>
